...
exports.checkRights = exports.validateUser = void 0;
...
var jwtService = new jwtServices_1.jwtServices();
var superAdminRoleId = 1;
var userRepository = new userRepo_1.userRepo();
var userRoleRepository = new userRoleMapRepo_1.userRoleRepo();
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                userDetails = jwtService.verifyToken(token);
                if (!userDetails) return [3 /*break*/, 5];
                email = userDetails.Email;
                return [4 /*yield*/, userRepository.getUser(email)];
            case 1:
                user = _c.sent();
                if (!user) return [3 /*break*/, 3];
                _a = userDetails;
                _b = 'isAdmin';
                return [4 /*yield*/, (0, exports.checkRights)(user, superAdminRoleId)];
            case 2:
                _a[_b] = _c.sent();
...
var checkRights = function (user, roleId) { return __awaiter(void 0, void 0, void 0, function () {
    var userRoles, _i, userRoles_1, role;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, userRoleRepository.getUserRoles(user)];
            case 1:
                userRoles = _a.sent();
