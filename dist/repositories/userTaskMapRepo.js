...
exports.UserTaskMapRepo = void 0;
    ...
    function UserTaskMapRepo() {
        ...
        this.addTask = function (task, user) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        newUserTaskMapping = this.repo.create();
        ...
        this.repo = dataSource_1.AppDataSource.getRepository(userTaskMapping_1.UserTaskMapping);
    }
    return UserTaskMapRepo;
}());
exports.UserTaskMapRepo = UserTaskMapRepo;
