...
var defaultUserRoleId = 2; // user role id
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        accessToken = jwtService.generateJwtToken(email);
                        return [4 /*yield*/, userRepository.addUser(username, email, hashedPassword, accessToken)];
                    case 3:
                        response = _a.sent();
                        if (!(response.message == 'sucess')) return [3 /*break*/, 5];
                        return [4 /*yield*/, userRoleRepository.addUserRole(email, defaultUserRoleId)];
                    case 4:
                        _a.sent();
                        _a.label = 5;
