...
var signInServices = /** @class */ (function () {
    function signInServices() {
        ...
        this.signIn = function (email) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        user = _a.sent();
                        return [4 /*yield*/, this.authMiddleware.checkRights(user, this.adminRoleID)];
                    case 2:
                        isAdmin = _a.sent();
                        return [4 /*yield*/, this.userRepository.updateToken(user, accessToken)];
                    case 3:
                        _a.sent();
        ...
        this.registerUserToDb = function (username, email, password) { return __awaiter(_this, void 0, void 0, function () {
            var saltRounds, salt, hashedPassword, accessToken, response, user, role;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 3:
                        response = _a.sent();
                        if (!(response.message == 'sucess')) return [3 /*break*/, 7];
                        return [4 /*yield*/, this.userRepository.getOneByEmail(email)];
                    case 4:
                        user = _a.sent();
                        return [4 /*yield*/, this.roleRepository.getOneById(this.defaultUserRoleId)];
                    case 5:
                        role = _a.sent();
                        return [4 /*yield*/, this.userRepository.addRole(user, role)];
                    case 6:
                        _a.sent();
                        _a.label = 7;
        ...
        this.authMiddleware = new middlewares_1.AuthMiddleWare();
    }
